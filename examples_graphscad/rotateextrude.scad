...
{
 function node_square_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = translate([1,0,0]);
 module node_square(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  translate([1,0,0])square(size=[1,1],center=false);
 }
 ...
 {
  rotate_extrude(angle=180,convexity=3,$fn=120)
  {
