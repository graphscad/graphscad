...
//
//------------------------------------------------------------------------------------------
use <examples_graphscad/rgbcube.scad>
use <examples_graphscad/pulleydemo.scad>
use <examples_graphscad/multicopter.scad>
use <examples_graphscad/robotwheel.scad>
use <examples_graphscad/fibonacisphere.scad>
module callmodule()
{
            ...
            "inputplugs": [
                {
                    "type": "filename",
                    "name": "filename",
                    "value": "examples_graphscad/rgbcube.scad"
                },
                {
                    "type": "str",
                    "name": "tx",
            ...
            "inputplugs": [
                {
                    "type": "filename",
                    "name": "filename",
                    "value": "examples_graphscad/pulleydemo.scad"
                },
                {
                    "type": "str",
                    "name": "tx",
            ...
            "inputplugs": [
                {
                    "type": "filename",
                    "name": "filename",
                    "value": "examples_graphscad/fibonacisphere.scad"
                },
                {
                    "type": "str",
                    "name": "tx",
            ...
            "inputplugs": [
                {
                    "type": "filename",
                    "name": "filename",
                    "value": "examples_graphscad/multicopter.scad"
                },
                {
                    "type": "str",
                    "name": "tx",
