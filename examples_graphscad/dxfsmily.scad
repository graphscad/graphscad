...
module dxfsmily()
{
 ...
 {
  import("examples_graphscad/smily.dxf",convexity=3);
 }
 ...
 {
  linear_extrude(height=4,center=true,convexity=1,twist=0,slices=1,scale=1)
  {
            ...
            "inputplugs": [
                {
                    "type": "filename",
                    "name": "filename",
                    "value": "examples_graphscad/smily.dxf"
                },
                {
                    "type": "str",
                    "name": "convexity",
            ...
            "inputplugs": [
                {
                    "type": "str",
                    "name": "comment",
                    "value": "import 2D object and extrude it\n"
                }
            ],
