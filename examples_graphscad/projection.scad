...
module projection()
{
 ...
 function node_projection_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = node_rotate_matrix(i=i,j=j,k=k,l=l,m=m,n=n);
 module node_projection(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  {
 ...
 function node_rotate_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = rotate([45,45,45])*node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n);
 module node_rotate(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  rotate([45,45,45])node_cube(i,j,k,l,m,n);
 }
...
/*BEGINGRAPHSCAD{
    "nodes": [
        ...
        },
        {
            ...
            "inputplugs": [
                {
                    "connection": "node_projection.object2d",
                    "type": "object2d",
                    "name": "object2d",
                    "value": ""
                },
